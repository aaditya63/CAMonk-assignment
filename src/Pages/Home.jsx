  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-1 bg-[#f8f8f8f8] flex justify-center items-center">
        <div className="h-[472px] w-[627px] flex flex-col items-center p-5">
          <img src={Logo} alt="here" className="h-[72px] w-[72px]" />
          <p className="w-full text-[40px] h-[46px] mt-[32px] flex items-center justify-center text-[#0F1010] font-bold">Sentence Construction</p>
          <p className="text-center h-[56px] mt-[12px] text-[#7C8181]">
          ...
          <div className="mt-[32px] h-[32px] w-full">
            <div className="flex items-center justify-between w-full">
              <div className="text-center w-[171px]">
                ...
                <p className="h-[28px] mt-[16px] text-[18px] text-[#7C8181]">30 sec</p>
              </div>
              <img src={Line} alt="" className="h-[54px]" />
              <div className="text-center w-[161px]">
                <p className="h-[28px] text-[20px]">Total Questions</p>
                <p className="h-[28px] mt-[16px] text-[18px] text-[#7C8181]">10</p>
              </div>
              <img src={Line} alt="" className="h-[54px]" />
              <div className="text-center w-[161px]">
                <p className="h-[28px] text-[20px]">Coins</p>
                <p className="h-[28px] mt-[16px] text-[18px] text-[#7C8181] flex justify-center"><img src={Ellipse} alt="" className="w-[16px] h-16px" />10</p>
              </div>
            </div>
          </div>
